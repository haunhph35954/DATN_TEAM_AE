...
public class DanhMuc {
    ...
    public DanhMuc(Integer id, String maDanhMuc, String tenDanhMuc, String trangThai, LocalDate ngayTao, LocalDate ngaySua, String nguoiTao, String nguoiSua, Boolean deleted) {
        this.id = id;
