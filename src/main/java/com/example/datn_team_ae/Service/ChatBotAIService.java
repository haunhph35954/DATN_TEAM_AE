...
public class ChatBotAIService {
    ...
    public String hoiGemini(String cauHoi, List<SanPhamTuVanDTO> danhSach) throws Exception {
        ...
        promptBuilder.append("Bạn là nhân viên tư vấn thời trang cho cửa hàng MinLiNa. ")
                ...
                .append("Khi hiển thị danh sách sản phẩm, hãy nhóm các biến thể (màu, size, số lượng) theo từng TÊN SẢN PHẨM. ")
                .append("Tên sản phẩm chỉ được hiển thị một lần.")
                .append("Các biến thể của sản phẩm nên được gộp dưới dạng danh sách màu sắc, danh sách kích thước, v.v. ")
                .append("CHỈ giới thiệu sản phẩm có tên chứa từ khóa khách hỏi.")
                .append("Khi khách hàng hỏi sản phẩm nào đẹp và bán chạy hãy gợi ý 2 sản phẩm số lượng ít nhất có trong kho.")
                .append("Nếu có ảnh, chỉ hiển thị 1 ảnh đại diện của sản phẩm là đủ.\n\n");
